...
import { IS_DOCUMENSO_OUTBOUND_EMAIL_DISABLED } from '../../constants/app';
...
export const createDocumentFromDirectTemplate = async ({
            ...
            createMany: {
              data: directTemplateNonSignatureFields.map(({ templateField, customText }) => {
                ...
                return {
                  envelopeId: createdEnvelope.id,
                  envelopeItemId:
                    oldEnvelopeItemToNewEnvelopeItemIdMap[templateField.envelopeItemId],
  ...
  if (emailSettings.ownerDocumentCreated && !IS_DOCUMENSO_OUTBOUND_EMAIL_DISABLED()) {
